...
class ParserConfig:
    ...
    def with_recognized_tags(self, tags: list[str]) -> Self: ...
    """Set the whitelist of recognized tags."""
    def with_unknown_mode(
    ...
    def with_trim_punctuation(self, val: bool) -> Self: ...
    """Enable/disable punctuation trimming for retro spans."""
    def with_autoclose_on_any_tag(self, val: bool) -> Self: ...
    """Auto-close open tags when any new tag starts."""
    def with_autoclose_on_same_tag(self, val: bool) -> Self: ...
    """Auto-close open tags when the same tag is seen again."""
    def with_case_sensitive_tags(self, val: bool) -> Self: ...
    """Enable/disable case-sensitive tag matching."""
    @classmethod
    def default_cite_config(cls) -> ParserConfig: ...
    """Return a default configuration for parsing <cite> tags."""

def parse(text: str, config: ParserConfig | None = None) -> ParseResult: ...
